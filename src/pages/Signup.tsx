...
export default function Signup() {
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        // If email confirmation is disabled in Supabase, session will exist immediately
        if (data.session) {
            navigate("/hub");
        } else {
    ...
    return (
        ...
        .sgi { width:100%; background:rgba(255,255,255,0.04); border:1px solid rgba(96,165,250,0.15);
          border-radius:10px; padding:12px 16px; color:#e2e8f0; font-size:14px; outline:none;
          transition:border-color .2s,box-shadow .2s; box-sizing:border-box;
          font-family:'DM Sans',sans-serif; }
        .sgi:focus { border-color:rgba(96,165,250,0.5); box-shadow:0 0 0 3px rgba(96,165,250,0.08); }
        .sgi::placeholder { color:#1e293b; }
      `}</style>
            ...
            <div style={{ position: "relative", zIndex: 1, width: "100%", maxWidth: 480, padding: "0 24px", animation: "fadeUp .7s ease both" }}>
                ...
                <div style={{
                    ...
                    <h2 style={{ color: "#f1f5f9", fontSize: 26, fontWeight: 800, margin: "0 0 6px", letterSpacing: "-0.02em" }}>Create an account</h2>
                    <p style={{ color: "#334155", fontSize: 14, margin: "0 0 32px", fontFamily: "'DM Sans',sans-serif", fontWeight: 300 }}>
                        Join Synapse with your university email
                    </p>
                    ...
                    <form onSubmit={handleSignup} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                        ...
                        <div>
                            ...
                            <input className="sgi" type="text" placeholder="Your full name"
                        ...
                        <div>
                            ...
                            <input className="sgi" type="email" placeholder="you@president.ac.id"
                        ...
                        <div>
                            ...
                            <div style={{ position: "relative" }}>
                                <input className="sgi" type={showPass ? "text" : "password"}
                        ...
                        <div>
                            ...
                            <div style={{ position: "relative" }}>
                                <input className="sgi" type={showConfirmPass ? "text" : "password"}
                        ...
                        {success && (
                            <div style={{
                                ...
                                borderRadius: 8, padding: "11px 14px", color: "#6ee7b7", fontSize: 13,
                                fontFamily: "'DM Sans',sans-serif",
                            }}>
                                {success}
                            </div>
                        ...
                        <button type="submit" disabled={loading} style={{
                            ...
                            {loading
                                ? <><div style={{ width: 16, height: 16, border: "2px solid rgba(255,255,255,0.3)", borderTop: "2px solid #fff", borderRadius: "50%", animation: "spin .7s linear infinite" }} /> Creating account...</>
                                : "Create account →"
                            }
                        </button>
                    </form>
